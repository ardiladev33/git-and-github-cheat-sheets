...
Si alguna vez necesitas ayuda al usar Git, hay tres formas equivalentes de obtener la página de manual (manpage) completa para cualquiera de los comandos de Git [1]:
...
```
git <command> --help || git command -h
```
...
For example, you can get the manpage help for the git config command by running this [1]:
